...
/**
 * FORM PENDAFTARAN — pemilihan jenis akun + Google OAuth SAJA.
 * Bukan autentikasi email/password; tanpa SMTP. Setelah Google,
 * user melengkapi data di /daftar/lengkapi (submit → complete_signup:
 * siswa langsung aktif, guru pending verifikasi Admin).
 */
function RegisterFormInner() {
  ...
  function googleSignup() {
    ...
    // OAuth kembali. Pilihan = PENGAJUAN, bukan hak akses. Admin tidak
    // bisa dipilih di sini (tidak tersedia pada registrasi publik).
      ...
      <main className="relative flex-1 flex items-center justify-center px-6 sm:px-10 py-12">
        ...
        <div className="w-full max-w-[380px]">
          ...
          <p className="text-on-surface-variant text-sm mb-8">
            Daftar menggunakan akun Google. Satu email Google hanya untuk
            satu akun KANUM.
          </p>
          ...
          <div>
            ...
            <p className="text-xs text-on-surface-variant mt-2 flex items-start gap-1.5">
              ...
              {role === "siswa"
                ? "Akun Siswa langsung aktif setelah pendaftaran — tanpa menunggu verifikasi."
                : "Pengajuan Guru diverifikasi Admin sebelum panel guru terbuka."}
            </p>
          </div>
          ...
          <button
            ...
            disabled={loading}
            className="w-full mt-6 bg-primary text-on-primary py-3.5 rounded-xl font-bold inline-flex items-center justify-center gap-2 hover:opacity-90 transition-opacity"
          >
            ...
            {loading ? "Mengalihkan ke Google..." : "Lanjutkan dengan Google"}
          </button>
